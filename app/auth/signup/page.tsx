...
function SignupForm() {
  ...
  if (tokenValid === false) {
    return (
      <div className="w-full max-w-md flex flex-col gap-4 text-center my-auto -ml-69">
  ...
  if (tokenValid === null) {
    return (
      <p className="text-zinc-500 dark:text-zinc-400 my-auto -ml-69">Verifying invitation…</p>
    )
  }

  return (
    <div className="w-full max-w-sm flex flex-col gap-6 my-auto -ml-69">
